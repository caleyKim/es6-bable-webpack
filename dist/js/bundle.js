...
window.onload = function () {
  ...
  var pp = new _lib__WEBPACK_IMPORTED_MODULE_0__["List"]('lsit', data);
  var uu = new _lib__WEBPACK_IMPORTED_MODULE_0__["Ttt"]('lsit', data, '?????');
  uu.output();
...
function () {
  ...
  _createClass(List, [{
    key: "printItems",
    value: function printItems() {
      var el = '';

      for (var i in this.data) {
        el += "<li>\uC5D8\uB9AC\uBA3C\uD2B8 \uCD9C\uB825 ".concat(this.data[i].title, "</li>");
      }
...
function (_List) {
  ...
  function Ttt(target) {
    ...
    var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    var upgrade = arguments.length > 2 ? arguments[2] : undefined;

    _classCallCheck(this, Ttt);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Ttt).call(this, target, data));
